...
menu.required_echoes_label:set_text("Требуется")
...
menu.vitality_label:set_text("Живучесть")
...
menu.endurance_label:set_text("Выносливость")
